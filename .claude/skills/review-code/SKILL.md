---
name: review-code
description: Review code from multiple technical perspectives (simplicity, Bevy/ECS idioms, testability)
argument-hint: [file-or-directory-path]
---

## Multi-Perspective Code Review

You are reviewing code in this project. Your job is to provide three independent expert reviews, then synthesize them.
